...
# Description:  This code performs a clip on parks and bike routes within a zip code as well as creates a 500 meter buffer around facilities.  The output can be used to inform the UN of safety concerns with bike routes within the buffer of facility locations.

# Add parks.shp and zip.shp to contents on .mxd manually
...
# Add facilities.shp to contents on .mxd manually
...
xy_tolerance="" # XY tolerance is set to NULL
